const Home = () => {
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold text-[#2f496e] mb-4">Bem-vindo à Home</h2>
      ...
      <div className="columns-1 sm:columns-2 lg:columns-4 gap-4 space-y-4">
        ...
        {/* Card estilo pin */}
        <div className="bg-white break-inside-avoid rounded-lg shadow-md overflow-hidden relative">
          <img
